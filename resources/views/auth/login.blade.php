...
@section('content')
<main class="auth">
      <header id="auth-header" class="auth-header" style="background-image: url(assets/images/illustration/img-1.pn);">
        <h1>
          <svg xmlns="http://www.w3.org/2000/" xmlns:xlink="http://www.w3.org/1999/xlink" height="64" viewbox="0 0 351 100">
            <defs>
