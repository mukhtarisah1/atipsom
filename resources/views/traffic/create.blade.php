...
@section('content')
        ...
        <div class="form-wizard">
            ...
            <form method="post" action="{{ route('traffic-in-person.store') }}" enctype="multipart/form-data">
                <div class="form-step">
                ...
                <div class="form-step">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="passport" class="form-control" value="{{ old('passport') }}">
                ...
                <div class="form-step">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="origin_or_source" class="form-control" value="{{ old('origin_or_source') }}">
                        <p style="color:red">@error('origin_or_source') {{$message}} @endError</p>
                    </div>
                    <div class="form-group">
                        <label for="transit">Transit:</label>
                        <input type="text" name= "transit" class="form-control" value="{{ old('transit') }}">
                        <p style="color:red">@error('transit') {{$message}} @endError</p>
                    </div>
                    <div class="form-group">
                        <label for="entry_point">Entry Point:</label>
                        <input type="text" name="entry_point" class="form-control" value="{{ old('entry_point') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="exit_point" class="form-control" value="{{ old('exit_point') }}">
                        <p style="color:red">@error('exit_point') {{$message}} @endError</p>
                    </div>
                    <div class="form-group">
                        <label for="reason_return">Reason for Return:</label>
                        <input type="text" name="reason_return" class="form-control" value="{{ old('reason_return') }}">
                ...
                <div class="form-step">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="languages_spoken" class="form-control" value="{{ old('languages_spoken') }}">
