                        ...
                        <tbody>
                          ...
                          @foreach ($trafficPersons as $trafficPerson)
                            <tr>
                                ...
                                <td>
                                <a href="{{ route('traffic-in-person.show', $trafficPerson->id) }}" class="tile tile-img mr-1"><img class="img-fluid" src="assets/images/dummy/img-1.jpg" alt="Card image cap"></a> <a href="#">{{ $trafficPerson->surname }} {{ $trafficPerson->given_name }}</a>
                                </td>
